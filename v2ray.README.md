# v2raymulti
با یک کلیک کانفیگ v2ray بساز
این دستور بصورت انگلیسی هست و توضیح داده که چطوری کار میکنه
اما این دستور پنل نداره یعنی مثل x-ui نیست فقط از طریق ترمینال میتونین مدیریت کنین
قبل شروع نصب حتما سرور و آپدیت و آپگرید کنین ، و پیشنهاد میکنم روی اوبونتو 20 نصب کنین که باگ و ایرادی نداشته باشین
